...
exports.run = async (bot, msg, args) => {
        ...
        .replace("dnd", `<:dnd:809151992420761641> | **Rahatsız Etmeyin**`)
        .replace("online", `<:online:811646407244906496>  | **Çevrimiçi**`)
        .replace("idle", `<:idle:809152492091867208>  | **Boşta**`)
        .replace("offline", `<:offline:809152965239504966>  | **Çevrimdışı**`)
