...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:carpi:821416413138911272>  **Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.channel.send(`<a:carpi:821416413138911272>   **Bu özellik zaten kapalı! :wink: **`)
 
 
  message.channel.send(`<a:onayl:809153025234305024> **Kayıt Sistemi başarılı bir şekilde kapatıldı.**`)
