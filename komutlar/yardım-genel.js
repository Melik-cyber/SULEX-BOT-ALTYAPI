...
.addField(`__Profil__`,`<a:bit2:809151548835102763>  \`${prefix}profil\` Kullanıcı Profilinizi Gösterir`,true)
.addField(`__Oylama__`,`<a:an:809151469655425127>  \`${prefix}oylama\` Sunucuda Oylama Başlatır`,true)
.addField(`__Duyuru__`,`<a:an:809151469655425127> \`${prefix}duyuru\` Sunucuda Duyuru Yapar`,true)
.addField(`__SunucuBilgi__`,`<a:an:809151469655425127> \`${prefix}sunucu-bilgi\` Sunucu Bilgilerini Gösterir`,true)
