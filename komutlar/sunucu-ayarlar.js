...
const sayfa = [`**${message.guild.name} | Sunucu Ayarları**\n**Botun Prefixi :** \`${p}\n**Reklam Engel:** ${db.fetch(`reklamengel_${message.guild.id}`) ? `<:ak:827269159796080640>` : `<:kapal:827269229489029181>` }\n**Küfür Engel:** ${db.fetch(`kufurE_${message.guild.id}`) ? `<:ak:827269159796080640>` : `<:kapal:827269229489029181>` }`] 
